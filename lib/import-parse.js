// lib/import-parse.js
//
// Implements the "extraction" half of FR1.1-FR1.6 / architecture §8 for the
...
// committed (FR1.3): { name, phone, category, confidence, raw_source_line, include }
//
// XLSX/DOCX/PDF/photo formats genuinely need a document/vision extraction
// service in production (architecture §8, open question #9) — this demo
